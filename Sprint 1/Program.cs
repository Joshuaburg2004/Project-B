                        ...
                        while (true)
{
    ...
    while (go_back_to_guests)
    {
        ...
        else if (guests > 6)
        {
            RestaurantInfo info = new();
            Console.WriteLine($"If you wish to reserve a table for more than 6 guests you will need to call us at: {info.Telefoonnummer})");
            break;  //maak ff een bool aan om ervoor tezorgen 
        }
    ...
    {
        Console.WriteLine("date test");
        Console.WriteLine("Do you want to quit or go back to table selection? (1) to quit (2) to go back to tables (3) no");
        int confirmation = Convert.ToInt32(Console.ReadLine());
        if (confirmation == 1)
        {
            end = true;
